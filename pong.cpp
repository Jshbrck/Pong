...
int main(int argc, char **argv){
    ...
    Rect p1 (al_get_backbuffer(sys.display),b_len, b_wdth, true, p1_x, p1_y,al_color_name("white"));
    Rect p2 (al_get_backbuffer(sys.display),b_len, b_wdth, true, p2_x, p2_y,al_color_name("white"));   
